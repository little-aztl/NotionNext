...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '岸芷汀兰，郁郁青青。, 没有一劳永逸，永远要重新开始，重新进入动荡，重新寻找，重新赢得欢喜。',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://little-aztl.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '岸芷汀兰的小房间', // 网站关键词 英文逗号隔开
